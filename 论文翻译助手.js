...
(function () {
    ...
    $("body").prepend(
        ...
        + '<a id="google-translate" href="https://translate.google.cn/" style="text-decoration: none; color: #fff; font-size: 14px;" target="_blank">Google翻译</a> | '
        ...
        + '<textarea id="old-text" style="height: 90px; width: calc(50% - 10px); border: 1px solid rgb(50,54,57); padding: 4px; resize: none;">原文本</textarea>'
        + '<textarea id="new-text" style="height: 90px; width: calc(50% - 10px); border: 1px solid rgb(50,54,57); padding: 4px; resize: none;">规范化后的文本</textarea>'
        + '</div>'
        ...
        + '<button id="copy-button" style="cursor:pointer; margin-left: calc(100% - 180px); padding-top: 0px; padding-bottom: 2px; vertical-align: top; height: 20px; width: 52px; border: 0px; background-color: rgba(0,0,0,0); color: #fff; font-size: 12px;">复制</button>'
        + '</div>'
    );
